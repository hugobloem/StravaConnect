...
# **create_activity**
> DetailedActivity create_activity(name, type, start_date_local, elapsed_time, description=description, distance=distance, trainer=trainer, commute=commute, hide_from_home=hide_from_home)
...
hide_from_home = false # bool | Set to true to mute activity. (optional) (default to false)

try:
    # Create an Activity
    api_response = api_instance.create_activity(name, type, start_date_local, elapsed_time, description=description, distance=distance, trainer=trainer, commute=commute, hide_from_home=hide_from_home)
    pprint(api_response)
 ...
 **hide_from_home** | **bool**| Set to true to mute activity. | [optional] [default to false]
