...
class ActivitiesApi(object):
    ...
    def create_activity(self, name, type, start_date_local, elapsed_time, **kwargs):  # noqa: E501
        ...
        :param bool hide_from_home: Set to true to mute activity.
    ...
    def create_activity_with_http_info(self, name, type, start_date_local, elapsed_time, **kwargs):  # noqa: E501
        ...
        all_params = ['name', 'type', 'start_date_local', 'elapsed_time', 'description', 'distance', 'trainer', 'commute', 'hide_from_home']  # noqa: E501
        ...
        if 'hide_from_home' in params:
            form_params.append(('hide_from_home', params['hide_from_home']))  # noqa: E501
